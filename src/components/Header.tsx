  ...
  return(
    <>
      ...
      <div className="absolute">
        <div className={`relative px-40 py-40 text-center md:text-right text-primary_text_color transition duration-300 w-screen ${!isOpen ? `opacity-0 translate-y-10 pointer-events-none delay-300 duration-400 z-0` : `opacity-100 translate-y-0 pointer-events-auto delay-300 z-50`}`}>
          test
        </div>
      </div>
    </>
