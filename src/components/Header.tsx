  ...
  return(
    <>
      ...
      <div className="absolute">
        <div className={`fixed px-20 py-20 md:px-40 md:py-40 text-center max-md:flex max-md:flex-col max-md:items-start min-md:justify-center md:text-right text-primary_text_color transition-all duration-500 w-screen ${!isOpen ? `opacity-0 translate-y-10 pointer-events-none delay-300 duration-200 z-0` : `opacity-100 translate-y-0 pointer-events-auto delay-300 z-50`}`}>
          <ul className="list-none md:flex md:items-start space-y-8 md:space-y-0 md:space-x-8 md:flex-row-reverse">
            <li>
              <span className="min-md:flex min:md-justify-center min-md:items-center">
            ...
            <li className="text-3xl md:[writing-mode:vertical-rl] transition-all duration-150 hover:opacity-60">
              <Link href={"/"} onClick={()=>setOpen(!isOpen)}>トップページ</Link>
            </li>
            <li className="text-3xl md:[writing-mode:vertical-rl] transition-all duration-150 hover:opacity-60">
              <Link href={"/#for-visitor"} onClick={()=>setOpen(!isOpen)}>ご来場の皆様へ</Link>
            </li>
            <li className="text-3xl md:[writing-mode:vertical-rl] transition-all duration-150 hover:opacity-60">
