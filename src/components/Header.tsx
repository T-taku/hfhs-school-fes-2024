  ...
  return(
    <>
      ...
      <div className="relative">
        <div className={`fixed my-60 px-40 bottom-0 text-center text-primary_text_color transition-all duration-300 w-screen ${!isOpen ? `opacity-0 translate-y-10 pointer-events-none delay-300 duration-200 z-0` : `opacity-100 translate-y-0 pointer-events-auto delay-300 z-50`}`}>
