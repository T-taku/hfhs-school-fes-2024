        ...
        <div className="container p-6 mx-auto">
            <div className="lg:flex">
                <div className="w-full -mx-6 lg:w-1/2">
                    <div className="px-6">
                        <Link href="#">
                            <Image className="w-auto h-7" src="/logo_white_1.png" width="300" height="300" alt=""/>
                        </Link>

                        <p className="max-w-sm mt-2 text-primary_text_color">2024年6月7日, 8日 開催</p>
                ...
                <div className="mt-6 lg:mt-0 lg:flex-1">
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        <div>
                          <h3 className=" uppercase text-primary_text_color">学園祭について</h3>
                        ...
                        <div>
                          <h3 className=" uppercase text-primary_text_color">学園祭の楽しみ方</h3>
                        ...
                        <div>
                          <h3 className=" uppercase text-primary_text_color">このウェブサイトについて</h3>
                          <Link href="/privacy-policy" className="block mt-2 text-sm  text-primary_text_color hover:underline">個人情報保護方針</Link>
                        </div>

                        <div>
                          <h3 className=" uppercase text-primary_text_color">学校法人 東福岡学園</h3>
