            ...
            <div className="mt-6 lg:mt-0 lg:flex-1">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <div>
                  ...
                  <Link href="https://www.higashifukuoka.ed.jp" className="block mt-2 text-sm  text-primary_text_color hover:underline" prefetch={false}>学校法人 東福岡学園</Link>
                  <Link href="https://www.higashifukuoka.ed.jp/highschool/" className="block mt-2 text-sm  text-primary_text_color hover:underline" prefetch={false}>東福岡高等学校</Link>
                  <Link href="https://www.higashifukuoka.ed.jp/juniorhighschool/" className="block mt-2 text-sm  text-primary_text_color hover:underline" prefetch={false}>東福岡自彊館中学校</Link>
                  <Link href="http://www.higashifukuoka.ed.jp/kyogaku/" className="block mt-2 text-sm  text-primary_text_color hover:underline" prefetch={false}>共学化特設サイト</Link>
                </div>
